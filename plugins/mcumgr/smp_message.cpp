...
void smp_message::start_message(smp_op_t op, uint8_t version, uint16_t group, uint8_t id, bool use_cbor_writer)
{
    ...
    this->cbor_writer_in_use = use_cbor_writer;
    if(cbor_writer_in_use){
